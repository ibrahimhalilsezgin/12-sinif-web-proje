<aside class="panel-sidebar" id="sidebar">
    <div style="margin-bottom: 40px; padding: 0 20px; display: flex; justify-content: space-between; align-items: center;">
        ...
        <button class="mobile-toggle d-md-none" onclick="toggleSidebar()" style="background: none; border: none; color: white; cursor: pointer;">
...
<div class="mobile-panel-header d-md-none" style="background: white; padding: 15px 20px; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--border); position: sticky; top: 0; z-index: 1500; width: 100%;">
    <a href="../index.php" class="logo" style="font-size: 1.25rem;">STORE<span>.PHP</span></a>
    <button onclick="toggleSidebar()" style="background: var(--secondary); color: white; border: none; padding: 8px 12px; border-radius: 8px; cursor: pointer; display: flex; align-items: center; justify-content: center;">
